...
The Opaque Pattern hides the implementation details of an object from its users by exposing only an abstract handle, which is denotef by a `h` (`hAnyObject_t`). 
...
This handle is the pointer of typedef for an hidden struct. __Handles__ generally indicates working with the pointer of a fully typedef struct.

The handle struct is __declared__ in the header file but __defined__ only in the source file, ensuring the object's internal details remain hidden from external modules.
...
Let's use another simple geometric shape, a **Circle**, as example.

In the header file, before allocation we have to define the size in order to statically allocate the object size.
...
the opaque object is declared as a pointer to an incomplete type.
...
<!-- {--{ file "src/patterns/include/opaquePattern.h" type="struct" name="opaqueStruct" }}
--{--{ file "src/patterns/include/opaquePattern.h" type="typedef" name="hOpaqueObject_t" }} -->
...
<!-- {--{ file "src/patterns/include/opaquePattern.h" type="typedef" name="opaqueObject_config_t" }}
{--{ file "src/patterns/include/opaquePattern.h" type="function" name="oop_Init" }}
{--{ file "src/patterns/include/opaquePattern.h" type="function" name="oop_DeInit" }} -->
...
<!-- {--{ file "src/patterns/include/opaquePattern.h" type="function" name="oop_setParameter" }}
{--{ file "src/patterns/include/opaquePattern.h" type="function" name="oop_getFlags" }}
{--{ file "src/patterns/include/opaquePattern.h" type="function" name="oop_getParameters" }} -->
...
<!-- {--{ file "src/patterns/include/opaquePattern.h" type="function" name="oop_size" }}
{--{ file "src/patterns/include/opaquePattern.h" type="function" name="oop_new" }}
{--{ file "src/patterns/include/opaquePattern.h" type="function" name="oop_free" }} -->
...
<!-- {--{ file "src/patterns/opaquePattern.c" type="struct" name="opaqueStruct" }} -->
...
<!-- {--{ file "src/patterns/opaquePattern.c" type="function" name="oop_Init" }}
{--{ file "src/patterns/opaquePattern.c" type="function" name="oop_DeInit" }} -->
...
<!-- {--{ file "src/patterns/opaquePattern.c" type="function" name="oop_setParameter" }}
{--{ file "src/patterns/opaquePattern.c" type="function" name="oop_getFlags" }}
{--{ file "src/patterns/opaquePattern.c" type="function" name="oop_getParameters" }} -->
...
<!-- {--{ file "src/patterns/opaquePattern.c" type="function" name="oop_size" }}
{--{ file "src/patterns/opaquePattern.c" type="function" name="oop_new" }}
{--{ file "src/patterns/opaquePattern.c" type="function" name="oop_free" }} -->
