...
The Observer Pattern extends the same `canvas` module from the Simple Callback Pattern (section 3.9). While the position listener from the Simple Callback Pattern (section 3.9) is a 1:1 callback for every position change, the move observer is a 1:N notification that fires **once** when a shape finishes its movement — and all registered observers receive it.
...
### Comparison with Simple Callback Pattern (section 3.9)

| Aspect | Simple Callback Pattern (section 3.9) | Observer Pattern (section 3.10) |
|--------|---------------------------------------|---------------------------------|
| Listeners | 1 | N |
